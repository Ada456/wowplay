    ...
    <div class="container">
        ...
        <nav class="collapse navbar-collapse pull-left">
            <ul class="nav navbar-nav topmenu">
                ...
                <li id="class_menu" class="nav-hover"><a
                        href="<%=basePath%>resources/front/main/sort_initSortTitle.action?sort.id=0">分类<b
                        class="caret"></b></a>
        ...
        <ul class="nav user-nav pull-right">
            <li class="guide-log-box"><a class="hz-guide-logo "
                                         href="#"> <img class="mian-log" style="width: 100px;"
                ...
                <c:if test="${person!=null}">
                    <li id="login_li" style="margin-top: 38px;">
                        <a style="display: inline;margin: 0px;padding: 0px;"
                           href="<%=basePath%>resources/front/person_main.jsp">【 ${person.realname}】</a>，您好
            ...
            <div style="margin-top: -20px;" class="label-row js-label-row js-sort-menu-category">
                <dl class="sort-menu sort-menu2 js-sort-menu clearfix">
                    ...
                    <c:forEach items="${queryTagList}" var="qTagsList">
                        <dd>
                            <a class="flags-item-unselected-js-tag"
                               href="<%=basePath%>resources/front/main/sort_afterRemoveTags.action?sort.id=${querySort}&tag.id=${qTagsList.id}">
